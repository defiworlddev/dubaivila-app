...
export const RequestList = () => {
  ...
  return (
    <div className="space-y-8">
      {/* Hero Section */}
      <section className="w-full bg-gradient-to-br from-primary-900 via-primary-800 to-primary-900 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-12 sm:py-16 mb-10">
        <div className="max-w-5xl mx-auto">
          <div className="text-center space-y-6">
            ...
            <p className="text-base sm:text-lg text-primary-100 leading-relaxed max-w-2xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <Link
          to="/request/new"
          className="inline-flex items-center gap-2 bg-primary-700 text-white px-6 py-3 rounded-lg font-semibold hover:bg-primary-800 transition-all duration-200 shadow-md hover:shadow-lg whitespace-nowrap"
        >
